...
#'
#' @param id_query A vector of transcript IDs that can correspond to the background transcript list
...
#'
#' @return A `dataframe` containing the biomaRt query results.
#' 
#' @export
#'
#' @examples

...
interact_table <- function(data) { 
  ...
  clustr_df4drplots_redund |> 
    ...
    DT::formatStyle("BMD.zSD", 
                    backgroundColor = styleEqual(unique(b_lonely_fishres$BMD.zSD),
                                                 color_vals(unique(b_lonely_fishres$BMD.zSD))
                                                 )
                    ) |> 
...
# Round the BMD value for better readability
b_lonely_fishres$BMD.zSD <- round(b_lonely_fishres$BMD.zSD, 1) 
...
color_func <- scales::col_numeric(palette = viridis::viridis_pal(alpha = 0.8, begin = 0.2, end= 0.9, direction = -1)(200), 
                           domain = range(b_lonely_fishres$BMD.zSD, na.rm = TRUE))
...
b_lonely_fishres_no_redund_selected <- b_lonely_fishres |> 

...
dr_g_string_clustr <- read.csv(here::here("outputs", params$`file-date`, "cytoscape-files", paste0("Resp_PPIN_clustered_cs09_mcl4_", params$`file-date`, ".csv")))
...
clustr_enrichres <- readRDS(here::here("outputs", params$`file-date`, paste0("clustr_enrichres_cs09_cf4_", params$`file-date`, ".rds")))
...
lonelyfishing_data <- readRDS(here::here("outputs", params$`file-date`, paste0("lonely_fishres_cs09_cf4_", params$`file-date`, ".rds")))

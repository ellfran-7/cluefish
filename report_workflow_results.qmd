...
output-file: "report_workflow_results_sc09_cf4_2024-07-21.html"
---
...
bg_t_ids <- read.table(here::here("outputs", paste0("bg_t_ids_", params$`file-date`, ".txt")))
...
dr_g_string_clustr <- read.csv(here::here("outputs", "cytoscape-files", paste0("Resp_PPIN_clustered_cs09_mcl4_", params$`file-date`, ".csv")))
...
clustr_enrichres <- readRDS(here::here("outputs", "cs09-cf4", paste0("clustr_enrichres_cs09_cf4_", params$`file-date`, ".rds")))
...
lonelyfishing_data <- readRDS(here::here("outputs", "cs09-cf4", paste0("lonely_fishres_cs09_cf4_", params$`file-date`, ".rds")))
...
## The **`r length(unique(b_lonely_fishres_no_redund_selected$new_clustr))`** clusters from highest to lowest sensitivity

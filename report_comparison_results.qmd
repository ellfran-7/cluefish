...
output-file: "report_comparison_results_sc09_cf4_2024-07-07.html"
---
...
stand_res <- readRDS(here::here("analyses", "standard_approach", "results", paste0("standard_pipeline_res_", params$`file-date`, ".rds")))
...
lonely_cluster_analysis_res <- readRDS(here::here("analyses", "lonely_cluster_analysis", "results", paste0("lonely_cluster_analysis_res_", params$`file-date`, ".rds")))
```

...
#
# The function used in the script has been developed for this project and can be found in the folder R/, under the name 'curves_to_pdf.R'.
#
...
curves_to_pdf(
  ...
  path = "outputs/",
  output_filename = "workflow_curvesplots.pdf"
)
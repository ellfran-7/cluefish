...
dl_regulation_data(
  url.tf = "https://guolab.wchscu.cn/AnimalTFDB4_static/download/TF_list_final/Danio_rerio_TF",
  url.cof = "https://guolab.wchscu.cn/AnimalTFDB4_static/download/Cof_list_final/Danio_rerio_Cof",
  path = "data/derived-data/",
  filename.tf = "Danio_rerio_TF.txt",
  filename.cof = "Danio_rerio_Cof.txt",
  overwrite = FALSE
)

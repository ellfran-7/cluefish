...
editor: visual
cap-location: margin
output-file: "lonely_results_report_sc09_cf4_2024-05-15.html"
---
...
|----------------|-------------------------------|---------------------------------------|
| GO:BP  | `r unique(lonely_cluster_analysis_res$dr_c_a_lonely[lonely_cluster_analysis_res$dr_c_a_lonely$source == "GO:BP",]$query)` | `r unique(lonely_cluster_analysis_res$dr_c_a_lonely[lonely_cluster_analysis_res$dr_c_a_lonely$source == "GO:BP",]$effective_domain_size)` |
| KEGG   | `r unique(lonely_cluster_analysis_res$dr_c_a_lonely[lonely_cluster_analysis_res$dr_c_a_lonely$source == "KEGG",]$query)`    | `r unique(lonely_cluster_analysis_res$dr_c_a_lonely[lonely_cluster_analysis_res$dr_c_a_lonely$source == "KEGG",]$effective_domain_size)`     |
| WP     | `r unique(lonely_cluster_analysis_res$dr_c_a_lonely[lonely_cluster_analysis_res$dr_c_a_lonely$source == "WP",]$query)`      | `r unique(lonely_cluster_analysis_res$dr_c_a_lonely[lonely_cluster_analysis_res$dr_c_a_lonely$source == "WP",]$effective_domain_size)`       |
...
# Generate the interactive table 
lonely_cluster_analysis_res$filtered$dr_c_a_lonely |> 

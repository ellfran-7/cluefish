...
editor: visual
cap-location: margin
output-file: "workflow_results_report_sc09_cf4_2024-07-03.html"
---
...
bg_t_ids <- read.table(here::here("outputs", "bg_t_ids_2024-07-01.txt"))
...
dr_g_string_clustr <- read.csv(here::here("outputs", "cytoscape-files", "Resp_PPIN_clustered_cs09_mcl4_2024-07-01.csv"))
...
clustr_enrichres <- readRDS(here::here("outputs", "cs09-cf4", "clustr_enrichres_cs09_cf4_2024-07-03.rds"))
...
lonelyfishing_data <- readRDS(here::here("outputs", "cs09-cf4", "lonely_fishres_cs09_cf4_2024-07-03.rds"))

...
editor: visual
cap-location: margin
output-file: "workflow_results_report_sc09_cf4_2024-05-01.html"
---
...
clustr_enrichres <- readRDS(here::here("outputs", "cs09-cf4", "clustr_enrichres_cs09_cf4_2024-04-30.rds"))
...
lonelyfishing_data <- readRDS(here::here("outputs", "cs09-cf4", "lonely_fishres_cs09_cf4_2024-04-30.rds"))
...
: Summary table of DRomics analysis {.table-bordered .light}
...
: Summary table of indentifier mapping {.table-bordered .light}
...
: Summary table of cluster and gene count before and after cluster filtering step {.table-bordered .light}
...
: Summary of background gene lists involved in functional enrichment for each source {.table-bordered .light}
...
: Summary table of gene, cluster and total term count during the cluster enrichment step {.table-bordered .light}
...
: Summary table of term count per source and per characteristic {.table-bordered .light}
...
: Summary table of the cluster count before and after cluster fusion {.table-bordered .light}
...
kableExtra::kable(same_value_rows, row.names = FALSE, booktabs = FALSE) |> 
...
: Summary table of all and only biologically annotated genes involved in the lonely fishing  {.table-bordered .light}

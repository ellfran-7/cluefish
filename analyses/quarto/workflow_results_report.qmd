...
output-file: "workflow_results_report_sc09_cf4_2024-07-07.html"
---
...
For a more detailed analysis of the lonely cluster (all of the lonely genes not affiliated with any pre-existing cluster), which is not covered here, a second Quarto report can be generated. This report performs a simple functional enrichment on the lonely genes, thereby shedding light on its context. You can find the Quarto document at [lonely_cluster_analysis.qmd](analyses/lonely_cluster_analysis/lonely_cluster_analysis.qmd).
